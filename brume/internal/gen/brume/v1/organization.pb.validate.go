...
// Validate checks the field values on ListOrganization with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *ListOrganization) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ListOrganization with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ListOrganizationMultiError, or nil if none found.
func (m *ListOrganization) ValidateAll() error {
	return m.validate(true)
}

func (m *ListOrganization) validate(all bool) error {
	if m == nil {
		return nil
	}
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ListOrganizationValidationError{
			...
			if err := v.Validate(); err != nil {
				return ListOrganizationValidationError{
					field:  fmt.Sprintf("Organizations[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return ListOrganizationMultiError(errors)
	}

	return nil
}

// ListOrganizationMultiError is an error wrapping multiple validation errors
// returned by ListOrganization.ValidateAll() if the designated constraints
// aren't met.
type ListOrganizationMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ListOrganizationMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ListOrganizationMultiError) AllErrors() []error { return m }

// ListOrganizationValidationError is the validation error returned by
// ListOrganization.Validate if the designated constraints aren't met.
type ListOrganizationValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ListOrganizationValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ListOrganizationValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ListOrganizationValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ListOrganizationValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ListOrganizationValidationError) ErrorName() string { return "ListOrganizationValidationError" }

// Error satisfies the builtin error interface
func (e ListOrganizationValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sListOrganization.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ListOrganizationValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ListOrganizationValidationError{}
