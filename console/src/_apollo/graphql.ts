...
export type CreateCloudAccountMutation = { __typename?: 'Mutation', createCloudAccount: { __typename?: 'CreateCloudAccountResponse', status: CloudStatus, logs: Array<string> } };
