    ...
    <div
      ...
      <div className="flex flex-col gap-3 p-2 py-3">
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-row items-center gap-2">
            ...
            />
            <p className="text-xs font-normal">CPU</p>
          </div>
        ...
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-row items-center gap-2">
            <Computer
              ...
              className="h-4 w-4 text-gray-800"
            />
            <p className="text-xs font-normal">Runner</p>
          </div>
          <p className="text-xs text-gray-800">Docker Runner</p>
        </div>
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-row items-center gap-2">
            <Drill
              ...
              className="h-4 w-4 text-gray-800"
            />
            <p className="text-xs font-normal">Builder</p>
          </div>
          <p className="text-xs text-gray-800">Docker Builder</p>
        </div>
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-row items-center gap-2">
            <Globe
        ...
        <div className="flex flex-row items-center justify-between">
          <div className="flex flex-row items-center gap-2">
            <GlobeLock
              ...
              className="h-4 w-4 text-gray-800"
            />
            <p className="text-xs font-normal">Private Net.</p>
          </div>
          <p className="font-mono text-xs text-gray-800">
      ...
      <div className="flex flex-row items-center justify-between gap-2 p-2">
        ...
        <Button
          ...
          onClick={() => {
            navigate(
              `/${projectId}/services/${props.id}/runner/variables`
            );
          }}>
          Variables
        </Button>
