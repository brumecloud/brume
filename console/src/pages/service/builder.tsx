...
export const BuilderPage = () => {
	...
	return (
		<div className="flex h-full flex-col px-32 pt-8">
			<div className="py-16">
				<h2 className="pb-2 font-heading text-3xl">Builder</h2>
					...
					>
						<div className="flex space-x-2">
							...
							>
								...
								<p className="text-sm text-gray-500">
									A simple docker image available from a registered docker
									registry.
								</p>
							</Label>
						</div>
						<div className="flex space-x-2">
							...
							<Label htmlFor="dockerfile" className="flex flex-col space-y-1">
								...
								<p className="text-sm text-gray-500">
									The artifact is a image, if a Dockerfile is present in the
									artifact it will be used to build the image. Otherwise, an
									automatic dockerfile will be created using Nixpack
								</p>
							</Label>
						</div>
						<div className="flex space-x-2">
							...
							>
								...
								<p className="text-sm text-gray-500">
									The artifact is a static website. The artifact will be served
									using a webserver (or a CDN like)
								</p>
							</Label>
						</div>
					</RadioGroup>
