...
export const AddDomain = () => (
  <Page.Container>
    <Page.Header>
      ...
      <Page.Description>
        Link a domain that you already own to your account using DNS NS records.
      </Page.Description>
    </Page.Header>
      ...
      <Stepper.Root shouldAnimate leftBorder>
        <Stepper.Item>
          ...
          <Stepper.Body>
            {({ setStep }) => (
              <>
                <div className="font-medium text-sm">Enter the domain name</div>
                ...
                <div>
                  <Select>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="chat-app">vibe-coded-chat</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div className="flex flex-row gap-2">
